...
-(void)didSelectSocialPlatform:(NSString *)platformName withSocialData:(UMSocialData *)socialData
{
    ...
    ary = [UMSocialData rt_ivars];
    ary1 = [UMSocialData rt_methods];
    ary2 = [UMSocialData rt_properties];
    ary3 = [UMSocialData rt_protocols];
    ary4 = [UMSocialData rt_subclasses];
